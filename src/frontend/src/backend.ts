...
import type { ShoppingCartView as _ShoppingCartView, StripeSessionStatus as _StripeSessionStatus, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addShoppingCart(arg0: ShoppingCartView): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addShoppingCart(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteShoppingCart(arg0: Principal): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteShoppingCart(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async downloadShoppingCart(arg0: Principal): Promise<ShoppingCartView | null> {
        if (this.processError) {
            try {
                const result = await this.actor.downloadShoppingCart(arg0);
    ...
    async getAllShoppingCarts(): Promise<Array<ShoppingCartView>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllShoppingCarts();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateShoppingCart(arg0: ShoppingCartView): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateShoppingCart(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async uploadShoppingCart(arg0: ShoppingCartView): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadShoppingCart(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_ShoppingCartView]): ShoppingCartView | null {
